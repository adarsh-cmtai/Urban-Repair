...
import { changeTechnicianPassword } from '@/services/technicianService';
...
export function PasswordForm() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        setIsLoading(true);
        try {
            const res = await changeTechnicianPassword({ oldPassword: formData.oldPassword, newPassword: formData.newPassword }, token!);
