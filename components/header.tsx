...
const navLinks = [
  {
    ...
    href: "/services",
    submenu: [
      { label: "AC Repair", href: "/services/ac-repair", icon: AirVent },
      { label: "Fridge Repair", href: "/services/fridge-repair", icon: Refrigerator },
      { label: "TV Repair", href: "/services/tv-repair", icon: Tv },
      { label: "Washing Machine Repair", href: "/services/washing-machine-repair", icon: WashingMachine },
    ],
  },
